...
Приложение для мониторинга использования Центрального процессора (ЦП). Приложение отображает текущее использование ЦП в процентах, записывает данные в файл/базу данных и строит график зависимости использования ЦП от времени, также отображает информацию о загруженности вашего ЦП на веб-страничке
...
- Запись данных в файл/базу даных для последующего анализа.
